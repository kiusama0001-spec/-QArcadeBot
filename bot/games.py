GAMES = {
    "pacman": ("Pac-Man", "Laberinto arcade: come puntos y evita enemigos."),
    "mario": ("Super Mario Bros.", "Plataformas retro: corre, salta y supera obstáculos."),
    "tetris": ("Tetris", "Clásico de bloques: acomoda las piezas y rompe récords."),
    "excitebike": ("Excitebike", "Carreras de motocross: velocidad y saltos."),
    "contra": ("Contra", "Acción run and gun: dispara y sobrevive."),
